 ...
 */
@Autonomous(name = "GR.calibrate", group = "Sensor")





public class OTOS_circle extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        fr = hardwareMap.get(DcMotorEx.class, "m0");
        br = hardwareMap.get(DcMotorEx.class, "m1");
        ...
        waitForStart();
        //creating functions for forward, left turn, right turn and backward
